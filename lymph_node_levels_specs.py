...
#        'lateral border': [{'border': ['lateral border'], 'structure': 'medial_surface_of_mandible'}]
    ...
    'level_ii_right': {
        ...
        'right border': [{'border': ['right border'], 'structure': 'sternocleidomastoid_right'}], #pixel le plus à gauche (ne pas prendre le muscle avec)
        },
    'level_iii_left': {
        'inferior border': [{'border': ['inferior point'], 'structure': 'cricoid_cartilage'}], #pixel le plus bas
        'superior border': [{'border': ['inferior point'], 'structure': 'hyoid'}], #pixel le plus bas
        'posterior border': [{'border': ['posterior point'], 'structure': 'sternocleidomastoid_left'}], #pixel le plus postérierue
        'anterior border': [{'border': ['anterior point'], 'structure': 'sternocleidomastoid_left'}], #pixel le plus antérieure
...
'level_iv_left': {
        'inferior border': [{'border': ['superior point'], 'structure': 'sternum'}], #pixel le plus haut
        'superior border': [{'border': ['inferior point'], 'structure': 'cricoid_cartilage'}], #pixel le plus bas
    ...
    'level_vib_left': {
        'inferior border': [{'border': ['superior point'], 'structure': 'sternum'}], #pixel le plus haut
        'superior border': [{'border': ['inferior point'], 'structure': 'thyroid_cartilage'}], #pixel le plus bas
